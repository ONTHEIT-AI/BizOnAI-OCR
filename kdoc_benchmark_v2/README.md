...
A second, larger Korean document OCR benchmark — **57,062 verified test cases across 850 single-page PDFs** from Korean public-sector documents. Plug-compatible with [olmOCR-Bench](https://huggingface.co/datasets/allenai/olmOCR-bench).

V2 is a complementary release alongside [v1](../kdoc_benchmark/) — v1 covers 804 industrial PDFs (contracts, medical, financial, logistics, education, etc.), V2 covers 850 public-sector PDFs (statistics, reports, manuals, notices) with much heavier table coverage.
...
- `data/pdfs/` — 850 single-page Korean public-sector PDFs (flat layout, Korean filenames)
- `data/text_present.jsonl` — sentence-level presence tests (6,292)
- `data/tables.jsonl` — table cell + adjacency tests (49,127)
- `data/header_footer_tests.jsonl` — header/footer absence tests (793)
- `data/categories.jsonl` — per-PDF category labels

**Total: 57,062 tests across 850 Korean public-sector documents in 4 categories.**
...
| Manuals    | 217 | Guidelines, manuals, standards, exam criteria, procedures |
