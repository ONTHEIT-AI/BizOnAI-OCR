...
from bizonai_ocr.model.schema import BatchInputItem, GenerationResult
from bizonai_ocr.model.util import scale_to_fit, detect_repeat_token
from bizonai_ocr.prompts import PROMPT_MAPPING
