...
from bizonai_ocr.input import load_file
from bizonai_ocr.model import InferenceManager
from bizonai_ocr.model.schema import BatchInputItem
...
def main(
    ...
    click.echo("BizOnAI-OCR - Starting OCR processing")
